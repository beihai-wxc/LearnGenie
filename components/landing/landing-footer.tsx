        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            ...
            <motion.button
              ...
              className="mt-10 inline-flex h-12 items-center gap-2 rounded-[32px] bg-[#181d27] px-8 text-[14px] font-semibold text-white shadow-[0_1px_2px_rgba(10,13,18,0.8),0_0_0_1px_#0a0d12]"
              whileHover={{ y: -2, boxShadow: '0 4px 12px rgba(10,13,18,0.4), 0 0 0 1px #0a0d12' }}
              whileTap={{ scale: 0.97 }}
