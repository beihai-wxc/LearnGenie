      ...
      <div className="relative flex w-full lg:w-1/2 items-center justify-center px-6">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2.5 text-[15px] leading-[1.6] text-[#6b6b80]">登录以继续你的学习之旅</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="mb-2 block text-[13px] font-semibold text-[#3a3a50]">邮箱 (测试邮箱:test@example.com)</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="mb-2 block text-[13px] font-semibold text-[#3a3a50]">密码 (测试密码:123456)</label>
            ...
            >
              {isLoading ? <Loader2 className="inline size-4 animate-spin" /> : '登 录'}
            </button>
          </form>
