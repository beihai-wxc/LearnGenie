...
export async function GET(
  ...
  return apiSuccess({
    document: {
      ...
      learningStage: document.learningStage,
      summary: document.summary,
      keywords: document.keywords,
      resourceTypes: document.resourceTypes,
      estimatedStudyTimeMinutes: document.estimatedStudyTimeMinutes,
      fullText: document.content,
      pdfAvailable: true,
      sourceType: document.sourceType,
      sourceLabel: document.sourceLabel || (document.sourceType === 'upload' ? '用户上传' : '核心知识'),
